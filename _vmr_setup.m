...
function vmr_inner(is_debug, is_short)
    ...
    home_path = getenv('HOME');  % Get the home directory path - allows for easy debugging in windows or linux

    settings = struct('id', 'test', 'group', 2, 'sign', 1, ...
                    'base_path', ref_path, 'data_path', fullfile(home_path, 'Downloads'));

% Now 'data_path' will be set to 'home/downloads'

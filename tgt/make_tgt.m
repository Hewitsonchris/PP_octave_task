...
repeated_target_angles = repmat(target_angles, 1, ceil(1 / length(target_angles)));
target_angles = repeated_target_angles(1:1);
...
block_level.max_rt = 0.6; % max reaction time before warning
